                ...
                return {
                    info(...args) {
                        console.log(
                            ...
                            `[${chalk.rgb(10, 214, 221)(new Date().toUTCString())}]:`,
                    ...
                    error(...args) {
                        console.log(
                            ...
                            `[${chalk.rgb(13, 206, 212)(new Date().toUTCString())}]:`,
                    ...
                    warn(...args) {
                        console.log(
                            ...
                            `[${chalk.rgb(14, 234, 241)(new Date().toUTCString())}]:`,
                    ...
                    trace(...args) {
                        console.log(
                            chalk.grey('TRACE '),
                            `[${chalk.rgb(5, 197, 223)(new Date().toUTCString())}]:`,
                    ...
                    debug(...args) {
                        console.log(
                            ...
                            `[${chalk.rgb(12, 209, 235)(new Date().toUTCString())}]:`,
                            chalk.white(format(...args))
                        )
                    }
                }
