...
sendAi: {
    async value(jid, title, body, text = '', thumbnailUrl, thumbnail, sourceUrl, quoted, LargerThumbnail = true) {
        console.log('sendAi called with parameters:', { jid, title, body, text, thumbnailUrl, thumbnail, sourceUrl, quoted, LargerThumbnail });
        
        try {
            const result = await conn.sendMessage(jid, {
                contextInfo: {
