...
export default async function (m, conn = { user: {} }) {
  ...
  console.log(`
${(chalk.cyan('╭────═[ �✨ BLUE ARCHIVE KIVOTOS ✨� ]═─────'))}
${(chalk.cyan('│╭───────────────···'))}
${(chalk.cyan('┴│� '))} ${chalk.blue('%s')}
${(chalk.cyan('B│� '))} ${chalk.black(chalk.cyan('%s'))}ㅤ${chalk.black(chalk.cyan('%s'))} 
${(chalk.cyan('L│� '))} ${chalk.magenta('%s [%s %sB]')}
${(chalk.cyan('U│� '))} ${chalk.white('%s')}
${(chalk.cyan('E│� '))} ${chalk.yellow('%s%s')}
${(chalk.cyan('A│� '))} ${chalk.magenta('%s')} ${chalk.black(chalk.red('%s'))}
${(chalk.cyan('R│💙 '))} ${chalk.cyan('🌸 Tachibana Nozomi System 🌸')}
${(chalk.cyan('C│💙 '))} ${chalk.magenta('⭐ Millennium Academy ⭐')}
${(chalk.cyan('H│💙 '))} ${chalk.green('🎯 SCHALE Processing 🎯')}
${(chalk.cyan('│╰────────────────···'))}
${(chalk.cyan('╰───────────═┅═──────────'))}
`.trim(),
    me + ' ~' + conn.user.name,
